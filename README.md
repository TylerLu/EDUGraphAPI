...
7. Click **All settings**, if the setting window did not show.
   ...
   * Click **Required permissions**. Add the following permissions:
     ...
     | ------------------------------ | ---------------------------------------- | ---------------------------------------- |
     | Microsoft Graph                | Read all users' full profiles<br> Read directory data | Read directory data<br>Read directory data<br>Access directory as the signed in user<br>Sign users in |
